...
?>
    ...
    <main id="primary" class="site-main">
        ...
        <div class="container mt-5 mx-auto p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg max-w-7xl md:flex md:items-start md:space-x-6">
        ...
        <div class="container mt-5 mx-auto p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg max-w-7xl md:flex md:items-start md:space-x-6">
            ...
            <div class="md:w-1/2 flex flex-col justify-between h-full space-y-6">
                <!-- Heading at the top -->
                <h2 class="text-4xl font-bold text-gray-800 dark:text-gray-100">Android and IOS APPs</h2>

                <!-- Description in the middle -->
                <p class="text-lg text-gray-700 dark:text-gray-300">
                    I am developing Android and IOS apps since college time.
                    I am top-rated and have a 100% success score on Upwork. I only choose the projects in which I can excel.
                </p>
            ...
            <div class="md:w-1/2 mt-6 md:mt-0">
                <div class="rounded-lg shadow-lg overflow-hidden">
                    <img class="rounded-lg" src="<?php echo get_template_directory_uri(); ?>/assets/images/client_review.png" alt="image description">
                </div>
            </div>
